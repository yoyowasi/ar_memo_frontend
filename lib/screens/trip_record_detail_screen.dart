            ...
            slivers: [
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  centerTitle: false,
                  title: Text(record.title, style: heading2.copyWith(color: Colors.white, shadows: [Shadow(blurRadius: 2, color: Colors.black.withAlpha((255 * 0.5).round()))]), maxLines: 1, overflow: TextOverflow.ellipsis),
                  background: record.photoUrls.isNotEmpty
                    ...
                    DecoratedBox(decoration: BoxDecoration(gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Colors.transparent, Colors.black.withAlpha((255 * 0.1).round()), Colors.black.withAlpha((255 * 0.5).round())], stops: const [0.5, 0.7, 1.0]))),
                  ],)
